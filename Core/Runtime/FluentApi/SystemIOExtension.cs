...
namespace YokiFrame
{
    ...
    {
        /// <summary>创建文件夹,如果存在则不创建</summary>
        ...
        /// <summary>清空 Dir（保留目录),如果存在</summary>
        ...
        public static string CombinePath(this string selfPath, string toCombinePath)
            => Path.Combine(selfPath, toCombinePath);

        /// <summary>根据路径获取文件名</summary>
        public static string GetFileName(this string filePath)
            => Path.GetFileName(filePath);

        /// <summary>根据路径获取文件名，不包含文件扩展名</summary>
        public static string GetFileNameWithoutExtend(this string filePath)
            => Path.GetFileNameWithoutExtension(filePath);

        /// <summary>根据路径获取文件扩展名</summary>
